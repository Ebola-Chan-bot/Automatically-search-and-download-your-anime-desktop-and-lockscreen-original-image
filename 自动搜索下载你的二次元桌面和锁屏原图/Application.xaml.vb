...
Class Application
	...
	Sub New()
		Dim 有人吗 As New EventWaitHandle(False, EventResetMode.AutoReset, "Asddl.有人吗"), 有人 As New EventWaitHandle(False, EventResetMode.AutoReset, "Asddl.有人"), 没人 As New EventWaitHandle(False, EventResetMode.AutoReset)
		有人.Reset()
		有人吗.Set()
		Task.Run(Sub()
